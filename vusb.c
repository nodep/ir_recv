...
#define CFG_INTERFACE_KEYBOARD_NAME		'I','R','/','R','C',' ','K','e','y','b','o','a','r','d'
#define CFG_INTERFACE_KEYBOARD_SZ   	14

#define CFG_INTERFACE_CONSUMER_NAME		'I','R','/','R','C',' ','M','e','d','i','a',' ','C','o','n','t','r','o','l'
#define CFG_INTERFACE_CONSUMER_SZ   	19
